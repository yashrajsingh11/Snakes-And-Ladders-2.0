...
public class ItemController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(myDiceRoller.canChoose == true && (myPassingData.myId - 1) == ((myDiceRoller.currentPlayerId + 1) % 2) && myDiceRoller.isLadder == true)
        {
        ...
        if(myDiceRoller.canChoose == true && (myPassingData.myId - 1) == ((myDiceRoller.currentPlayerId + 1) % 2) && myDiceRoller.isSnake == true)
        {
    ...
    void RPC_SyncingBooleanForAxe(int localId)
    {
        ...
        myDiceRoller.currentPlayerWantsToChoose = true;
        if((myPassingData.myId - 1) == ((myDiceRoller.currentPlayerId + 1) % 2))
        {
